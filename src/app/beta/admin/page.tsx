...
export default function BetaAdminPage() {
  const betaOptions = [
    ...
    },
    {
      ...
      description: 'Granska och hantera all insamlad feedback från beta-testare',
      icon: SettingsIcon,
      href: '/beta/admin/feedback'
    }
  ]
  ...
  return (
    <div className="h-full flex flex-col">
      <Header
        title="Beta Admin"
        description="Administrera beta-programmet och hantera feedback"
      />
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4 leading-relaxed">
                    Här kan du hantera alla aspekter av beta-programmet. Från att samla in feedback
                    till att granska förslag och buggrapporter från våra beta-testare.
                  </p>
