...
export interface JourneyMapData {
  ...
  rows: JourneyMapRow[]
  insights?: Insight[] // Insights attached to this journey map
...
export interface Insight {
  ...
  status?: 'todo' | 'in-progress' | 'done' // Track action status
  evidence: Evidence[]
  created_at: string
  created_by?: string
  // Auto-import fields
  source?: {
    type: 'nps' | 'csat' | 'ces' | 'interview' | 'survey' | 'manual'
    sourceId: string
    sourceName: string
    autoGenerated: boolean
  }
  autoPlaced?: boolean // Was this insight automatically placed
  suggestedCells?: {
    rowId: string
    cellId: string
    stageId: string
