...
const translations: Record<Language, Record<string, string>> = {
    sv: {
        ...
        'journeyMaps.subtitle': 'Skapa och hantera dina customer journey maps',
        'journeyMaps.createNew': 'Skapa ny Journey Map',
    ...
    en: {
        ...
        // Journey Maps
        'journeyMaps.title': 'Journey Maps',
        'journeyMaps.subtitle': 'Create and manage your customer journey maps',
        'journeyMaps.createNew': 'Create new Journey Map',
