...
const DotMaterial = shaderMaterial(
  {
    ...
    dotColor: new THREE.Color('#334155'), // Primary color (slate-700)
...
function Scene() {
  ...
  // Light theme colors for login page with primary color for hover
  const themeColors = {
    dotColor: '#334155', // Primary color (slate-700)
    bgColor: '#FFFFFF',
    dotOpacity: 0.15
  }
